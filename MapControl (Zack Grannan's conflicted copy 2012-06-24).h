...
namespace Skynet {
	...
	public:
		MapControl(void)
		{
			...
			_airplaneIcon = Image::FromFile( "C:\\Users\\ucsd_auvsi\\Dropbox\\Skynet\\Skynet\\Falco_small.png" );
			_targetIcon = Image::FromFile( "C:\\Users\\ucsd_auvsi\\Dropbox\\Skynet\\Skynet\\thumbtack_icon.png" );
