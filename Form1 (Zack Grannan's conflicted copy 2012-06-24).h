...
private: System::Windows::Forms::Label^  label7;
	...
	public:
		Form1(void)
		{
			...
			thePlaneWatcher = gcnew Communications::PlaneWatcher(this,appController->getAutosearch());
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->metadataTable->AlternatingRowsDefaultCellStyle = dataGridViewCellStyle10;
			...
			this->metadataTable->ColumnHeadersDefaultCellStyle = dataGridViewCellStyle11;
			...
			this->metadataTable->RowHeadersDefaultCellStyle = dataGridViewCellStyle12;
			...
			this->autosearchBox->SizeMode = System::Windows::Forms::PictureBoxSizeMode::StretchImage;
...
private: System::Void dataGridView3_CellDoubleClick(System::Object^  sender, System::Windows::Forms::DataGridViewCellEventArgs^  e) {
			 ...
			 if (e->ColumnIndex == VERIFIED_LOCK_ON_COLUMN) {
				 ...
				 String ^ id = Convert::ToString(dataGridView3->Rows[e->RowIndex]->Cells[CANDIDATEID_VERIFIED_COL]->Value);
				 Database::TargetRowData ^ data = appController->targetWithID(id);
